...
def main() -> None:
    ...
    if args.workers <= 1:
        ...
        # ProcessPoolExecutor par défaut utilise fork() sur Linux : les workers
        # héritent de _DATA (déjà rempli ci-dessus) par copy-on-write, sans le
        # repasser en argument ni le recharger.
